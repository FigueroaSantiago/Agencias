<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="itinerario" class="form-label">{{ __('Itinerario') }}</label>
            <input type="text" name="itinerario" class="form-control @error('itinerario') is-invalid @enderror" value="{{ old('itinerario', $viaje?->itinerario) }}" id="itinerario" placeholder="Itinerario">
            {!! $errors->first('itinerario', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="file" accept="image/*" name="img" class="form-control @error('img') is-invalid @enderror" value="{{ old('img', $viaje?->img) }}" id="img" placeholder="Img">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="file" accept="application/pdf" name="pdf" class="form-control @error('pdf') is-invalid @enderror" value="{{ old('pdf', $viaje?->pdf) }}" id="pdf" placeholder="Pdf">
